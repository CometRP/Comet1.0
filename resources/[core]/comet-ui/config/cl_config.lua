...
--[[
    ...
    (Full bonelist: comet-ui/bonelist.md)
        ...
        Options = {
            {
                ...
                EventType = 'Client',
                EventName = 'comet-vehicles/client/fuel/refuel-veh',
                EventParams = {},
                Enabled = function(Entity)
                    if exports['comet-vehicles']:IsElectricVehicle(Entity) then
                    ...
                    if exports['comet-vehicles']:CanRefuel() then
            ...
            },
            {
                ...
                EventType = 'Client',
                EventName = 'comet-police/client/scan-plate',
                EventParams = {},
                Enabled = function(Entity)
                    local Player = exports['comet-base']:FetchModule('Player').GetPlayerData()
            ...
            },
            {
                ...
                Icon = 'fas fa-redo',
                EventType = 'Client',
                EventName = 'comet-vehicles/client/try-flip-vehicle',
                EventParams = {},
                Enabled = function(Entity)
            ...
            },
            {
                ...
                EventType = 'Client',
                EventName = 'comet-business/client/hayes/check-vehicle',
                EventParams = {},
                Enabled = function(Entity)
                    return exports['comet-business']:IsHayes()
                end,
            },
            {
                Name = 'close_trunk',
                ...
                EventType = 'Client',
                EventName = 'comet-vehicles/client/toggle-door-data',
                EventParams = {
                    IsMenu = false,
                    DoorNumber = 5,
                },
            ...
            },
            {
                ...
                EventType = 'Client',
                EventName = 'comet-vehicles/client/get-in-trunk',
                EventParams = {},
                Enabled = function(Entity)
                    return ((GetBoneDistanceFromVehicle(2, "boot") < 1.20) and (GetVehicleDoorAngleRatio(Entity, 5) > 0.0))
                end,
            },
            {
                ...
                Icon = 'fas fa-spinner',
                EventType = 'Client',
                EventName = 'comet-vehicles/client/carry-bicycle',
                EventParams = {},
                Enabled = function(Entity)
            ...
            -- Oxy
            {
                ...
                Icon = 'fas fa-cubes',
                EventType = 'Client',
                EventName = 'comet-jobs/client/oxy/deliver-goods',
                EventParams = {},
                Enabled = function(Entity)
                    if not exports['comet-phone']:IsJobCenterTaskActive('oxy', 4) and not exports['comet-phone']:IsJobCenterTaskActive('oxy', 6) then return false end

                    if Entity == exports['comet-jobs']:GetOxyVehicle() then
                        return true
                    else
                        return false
                    end
            ...
            -- Sanitation
            {
                ...
                EventType = 'Client',
                EventName = 'comet-jobs/client/sanitation/throw-in-trash',
                EventParams = {},
                Enabled = function(Entity)
                    if exports['comet-phone']:IsJobCenterTaskActive('sanitation', 4) == false and exports['comet-phone']:IsJobCenterTaskActive('sanitation', 6) == false then return end
            ...
            },
            {
                ...
                Icon = 'fas fa-circle',
                EventType = 'Client',
                EventName = 'comet-jobs/client/sanitation/return-veh',
                EventParams = {},
                Enabled = function(Entity)
                    if not exports['comet-phone']:IsJobCenterTaskActive('sanitation', 7) then return false end
            ...
            -- Delivery
            {
                ...
                EventType = 'Client',
                EventName = 'comet-jobs/client/delivery/grab-goods',
                EventParams = {},
                Enabled = function(Entity)
                    if GetEntityModel(Entity) == GetHashKey("benson") and exports['comet-phone']:IsJobCenterTaskActive('delivery', 4) then
                        return true
                    else
                        return false
                    end
            ...
            },
            {
                ...
                Icon = 'fas fa-circle',
                EventType = 'Client',
                EventName = 'comet-jobs/client/delivery/return-veh',
                EventParams = {},
                Enabled = function(Entity)
                    if not exports['comet-phone']:IsJobCenterTaskActive('delivery', 5) then return false end
        ...
        Options = {
            {
                ...
                Icon = 'fas fa-anchor',
                EventType = 'Client',
                EventName = 'comet-items/client/use-anchor-lower',
                EventParams = {},
                Enabled = function(Entity)
                    return exports['comet-items']:CanDropAnchor()
                end,
            },
            {
                Name = 'anchor-up',
                ...
                Icon = 'fas fa-anchor',
                EventType = 'Client',
                EventName = 'comet-items/client/use-anchor-raise',
                EventParams = {},
                Enabled = function(Entity)
                    return exports['comet-items']:CanTiltAnchor()
                end,
            },
        ...
        Options = {
            {
                ...
                Icon = 'fas fa-gas-pump',
                EventType = 'Server',
                EventName = 'comet-vehicles/server/refuel-helicopter',
                EventParams = {},
                Enabled = function(Entity)
                    return exports['comet-vehicles']:CanRefuelAircraft(Entity)
                end,
            },
        }
    },
        ...
        Options = {
            {
                ...
                EventType = 'Client',
                EventName = 'comet-police/client/search-closest',
                EventParams = {},
                Enabled = function(Entity)
                    ...
                    if IsEntityPlayingAnim(ClosestPlayer['ClosestPlayerPed'], "missminuteman_1ig_2", "handsup_base", 3) or IsEntityPlayingAnim(ClosestPlayer['ClosestPlayerPed'], "mp_arresting", "idle", 3) or exports['comet-hospital']:IsTargetDead(ClosestPlayer['ClosestServer']) then
                        return true 
                    end
                    return false
                end,
