...
CloseRadio = function() {
    $.post('https://comet-ui/Radio/Close', JSON.stringify({}));
...
$(document).on('click', '.radio-button', function(e) {
    ...
    if (Type == 'on/off') {
        $.post('https://comet-ui/Radio/Click', JSON.stringify({}));
        $.post('https://comet-ui/Radio/TogglePower', JSON.stringify({}));
    } else if (Type == 'connect') {
        var ChannelToJoin = $('.radio-channel').val();
        $.post('https://comet-ui/Radio/Click', JSON.stringify({}));
        $.post('https://comet-ui/Radio/JoinRadio', JSON.stringify({Channel: ChannelToJoin}));
    } else if (Type == 'disconnect') {
        $.post('https://comet-ui/Radio/Click', JSON.stringify({}));
        $.post('https://comet-ui/Radio/LeaveRadio', JSON.stringify({}));
    }
});
