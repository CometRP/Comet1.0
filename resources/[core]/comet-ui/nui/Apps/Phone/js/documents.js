    ...
    [
        ...
        },
        {
            ...
            Callback: (Result) => {
                ...
                $.post("https://comet-phone/Documents/NewDocument", JSON.stringify({
                    Result: Result
                }), function(Document){
...
$(document).on('click', '.phone-documents-item', function(e){
    ...
    $.post("https://comet-phone/Documents/GetDocumentData", JSON.stringify({
    ...
    BuildDropdown([
        {
            ...
            Callback: () => {
                $.post("https://comet-phone/Documents/ShareLocal", JSON.stringify({
        ...
        },
        {
            ...
            Icon: 'fas fa-save',
            Callback: () => {
                $.post("https://comet-phone/Documents/Save", JSON.stringify({
                    DocumentId: CurrentDocument,
        ...
        },
        {
            ...
            Callback: () => {
                $('.phone-documents-document').hide();
                $.post("https://comet-phone/Documents/Delete", JSON.stringify({
                    DocumentId: CurrentDocument
                }), function(){
                    RefreshDocumentsItems();
                    $('.phone-documents-list').show();
...
function RefreshDocumentsItems(){
    ...
    $.post("https://comet-phone/Documents/GetDocumentsByType", JSON.stringify({
        Type: Type,
    }), function(Documents){
        $(".phone-documents-items").empty();
