    ...
    [
        ...
        },
        {
            ...
            Callback: (Result) => {
                ...
                $.post("https://comet-phone/Employment/SetEmployeeRank", JSON.stringify({
    ...
    [
        ...
        },
        {
            ...
            Callback: (Result) => {
                ...
                $.post('https://comet-phone/Employment/PayExternal', JSON.stringify({
                    BusinessName: CurrentBusinessData.name,
                    Result: Result,
                }), function(Result){
                    SetPhoneLoader(false);
    ...
    DoPhoneText('Are you sure you want to fire this person?', [
        ...
        },
        {
            ...
            Callback: (Result) => {
                ...
                $.post("https://comet-phone/Employment/RemoveEmployee", JSON.stringify({
                    BusinessName: CurrentBusinessData.name,
            ...
            Callback: () => {
                ...
                [
                    ...
                    },
                    {
                        ...
                        Callback: (Result) => {
                            $('.phone-input-wrapper').hide();
                            $.post("https://comet-phone/Employment/AddEmployee", JSON.stringify({
                                BusinessName: CurrentBusinessData.name,
                                Result: Result
                            }), function(Result){
                                if (Result.Success){
                ...
                [
                    ...
                    },
                    {
                        ...
                        Callback: (Result) => {
                            ...
                            $.post("https://comet-phone/Employment/ChargeCustomer", JSON.stringify({
                                BusinessName: CurrentBusinessData.name,
                ...
                [
                    ...
                    },
                    {
                        ...
                        Callback: (Result) => {
                            ...
                            $.post("https://comet-phone/Employment/CreateRank", JSON.stringify({
                                BusinessName: CurrentBusinessData.name,
                                Result: Result,
                            }), function(Success){
                                if (Success) {
                ...
                [
                    ...
                    },
                    {
                        ...
                        Callback: (Result) => {
                            ...
                            $.post("https://comet-phone/Employment/EditRank", JSON.stringify({
                                BusinessName: CurrentBusinessData.name,
                                Result: Result,
                            }), function(Success){
                                if (Success) {
                ...
                [
                    ...
                    },
                    {
                        ...
                        Callback: (Result) => {
                            ...
                            $.post("https://comet-phone/Employment/RemoveRank", JSON.stringify({
                                BusinessName: CurrentBusinessData.name,
                                Result: Result,
                            }), function(Success){
                                if (Success) {
...
var RefreshBusinessData = () => {
    $.post("https://comet-phone/Employment/GetSpecificBusiness", JSON.stringify({
