...
CloseDispatch = function() {
    ...
    $('.tooltip-css').remove();
    $.post('https://comet-ui/Police/CloseDispatch', JSON.stringify({}));
}
...
OpenDispatch = function() {
    if (!DispatchOpen) {
        ...
        $.post('https://comet-ui/Police/GetOnDutyPeople', JSON.stringify({}), function(Data) {
            if (Data != undefined && Data != null) {
                // $.post('https://comet-ui/Police/GetDispatchData', JSON.stringify({}), function(DispatchData) {
...
$(".duty-card-person").on("contextmenu", function(e) {
    ...
    // let DropDownItems = []
    // $.post('https://comet-ui/Police/GetDispatchData', JSON.stringify({}), function(Data) {
    //     if (Data != undefined && Data != null) {
...
$(document).on('click', '.police-alert-marker', function(e) {
    ...
    $.post('https://comet-ui/Police/SetWaypoint', JSON.stringify({Coords: Coords}));
});
