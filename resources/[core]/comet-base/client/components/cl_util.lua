...
Components.Util = Components.Util or {}

function Components.Util.MissionText(self, text, time)
...
function Components.Util.DrawText(self, text, font, centre, x, y, scale, r, g, b, a)
    SetTextFont(font)
    SetTextProportional(0)
    SetTextScale(scale, scale)
    SetTextColour(r, g, b, a)
...
function Components.Util.DrawText3D(self, x,y,z, text)
...
function Components.Util.RotationToDirection(self,rotation)
...
function Components.Util.ScreenRelToWorld(self,camPos,camRot,coord)

      local distance = 1000.0
      local camForward = Components.Util.RotationToDirection(self,camRot);
      ...
      local camRight = Components.Util.RotationToDirection(self,rotRight) - Components.Util.RotationToDirection(self,rotLeft);
      local camUp = Components.Util.RotationToDirection(self,rotUp) - Components.Util.RotationToDirection(self,rotDown);
