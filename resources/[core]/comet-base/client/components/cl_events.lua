...
RegisterNetEvent('comet-base:playerLoaded', function()
    ...
    if not Shared.Config.Server.PVP then return end
...
RegisterNetEvent('comet-base:spawnVehicle', function(model)
    ...
    local netId = Components.Callback.Execute("comet-vehicles:SpawnVehicle", {model = model, coords = vector4(x, y, z, w), warp = true})
