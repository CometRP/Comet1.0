...
--local NearNPC = exports["comet-base"]:GetClosestNPC()
--local handcuffed = exports["comet-base"]:isPed("handcuffed")
--local NearNPC = exports["comet-base"]:GetRandomNPC()
...
function isPed(checkType)
    ...
    if checkType == "cid" then
        pass = Components.PlayerData.cid
    end
    ...
    if checkType == "twitterhandle" then
        pass = "@" .. Components.PlayerData.firstname .. "_" .. Components.PlayerData.lastname
    end
    ...
    if checkType == "mybank" then
	    pass = Components.PlayerData.money.bank
    end
    ...
    if checkType == "mycash" then
	    pass = Components.PlayerData.money.cash
    end
...
-- RegisterNetEvent("qb-jobs:setJob")
-- AddEventHandler("qb-jobs:setJob", function(jobpassed, name, notify)
-- 	job = jobpassed
--     if not job then
--         job = "None"
--     end
