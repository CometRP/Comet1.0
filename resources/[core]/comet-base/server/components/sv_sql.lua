...
Components.SQL.execute = function(q, ...)
    local qPromise = promise:new()
...
Components.SQL.dynamicInsert = function(tableName, data, pReplaceInto)
    local qPromise = promise:new()
...
Components.SQL.dynamicUpdate = function(tableName, data, whereCondition, ...)
    local qPromise = promise:new()
...
Components.SQL.multiInsert = function(pQuery, pData, pIterator)
    local qPromise = promise:new()
