...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    disable = false
    TriggerServerEvent('comet-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('comet-weathersync:client:EnableSync', function()
    disable = false
    TriggerServerEvent('comet-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('comet-weathersync:client:DisableSync', function()
	disable = true
...
RegisterNetEvent('comet-weathersync:client:DisableContainer', function()
	disable = true
	CreateThread(function()
		while disable do
			SetRainLevel(0.0)
...
RegisterNetEvent('comet-weathersync:client:SyncWeather', function(NewWeather, newblackout)
    CurrentWeather = NewWeather
    blackout = newblackout
end)

RegisterNetEvent('comet-weathersync:client:SyncTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
