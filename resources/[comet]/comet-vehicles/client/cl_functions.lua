...
--[[
local coords = vector4(100.0, 100.0, 100.0, 100.0)
Vehicles.SpawnVehicle("sultan", coords, true, function(veh)
    SetVehicleNumberPlateText(veh, "GOV"..tostring(math.random(1000, 9999)))
    SetEntityHeading(veh, coords.w)
end)
--]]

Vehicles.SpawnClear = function(coords, radius)
    if coords then
...
Vehicles.GetProperties = function(vehicle)
...
Vehicles.GetProperties = function(vehicle, props)
    if DoesEntityExist(vehicle) then
